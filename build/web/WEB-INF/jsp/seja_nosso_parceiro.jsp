<%-- 
    Document   : seja_nosso_parceiro
    Created on : 05/12/2017, 07:09:45
    Author     : Home
--%>
                ...
                <div class="row">
                    ...
                    <div class="wow fadeInUp col-md-offset-1 col-md-5 col-sm-6" data-wow-delay="0.6s">
                        <div class="contact_des">
                            ...
                            <br/>
                            <br/>
                            <p style="font-size: 18px;">Já reparou que ouvimos mais sobre Netflix e menos video locadora? Mais Airbnb e menos hotel? Mais Uber e menos taxi? Estamos em uma fase de transiçao onde tudo enferruja cada vez mais rápido! </p>
                            <br/>
                            <p style="font-size: 18px;">Estamos em uma época que é preciso inovar. Não perca essa chance!</p>
                            <br/>
                            <p style="font-size: 18px;">Deixe seu contato e faça parte disso!</p>
                        </div>
                    </div>
