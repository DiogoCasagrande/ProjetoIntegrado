<%-- 
    Document   : login
    Created on : 06/12/2017, 02:59:37
    Author     : Home
--%>
        ...
        <section id="intro" class="parallax-section">
            <div class="container">
                <div class="row">
                    ...
                    <form action="/projeto-integrado2/efetuar_login" method="POST" style="padding-left: 40px;width: 40%">	    
                        <div class="contentform">

                            <div class="form-group">	
                                <span class="icon-case"><i class="fa fa-envelope-o"></i></span>
                                <input style="color:#000" type="email" name="email" id="email" placeholder="E-mail" data-rule="email" />
                                <div class="validation"></div>
                            </div>

                            <div class="form-group">	
                                <span class="icon-case"><i class="fa fa-unlock-alt"></i></span>
                                <input style="color:#000" type="password" name="senha" id="senha" placeholder="Senha" data-rule="email" />
                                <div class="validation"></div>
                            </div>

                            <button type="submit" class="btn btn-danger" style="margin-right: 30px;">ENTRAR</button>
                        </div>
                    </form>
